...
(function() {
    ...
    /***
     * 核心函数
     * _ 是一个构造函数 支持无new 调用的构造函数
     * 将传入的参数（实际要操作的数据）赋值给了 this._wrapped 属性
     * OOP 调用时，_ 相当于一个构造函数
     * each 等方法都在该构造函数的原型链上
     * _([1,2,3]).each(alert)
     * _([1,2,3]) 相对于无new 构造了一个新的对象
    */
    var _ = function(obj) {
    ...
    /**
     * 为什么JS库中做node环境兼容时要判断exports.nodeType是否为空
     * https://segmentfault.com/q/1010000015353836 
     * 
     * 在新版的浏览器中 可以不用声明直接获取id的元素(神奇的事情多了起来)
    */
    ...
    var optimizeCb = function(func, context, argCount) {
      ...
      switch (argCount == null ? 3 : argCount) {
        ...
        // The 2-argument case is omitted because we not using it.
